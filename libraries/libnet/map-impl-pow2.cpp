...
static int find_key(int *busybits, void **keyps, unsigned *k_hashes, int *chns, void *keyp, unsigned key_size, unsigned key_hash, unsigned capacity) {
...
static unsigned find_key_remove_chain(int *busybits, void **keyps, unsigned *k_hashes, int *chns, void *keyp, unsigned key_size, unsigned key_hash,
...
int map_impl_get(int *busybits, void **keyps, unsigned *k_hashes, int *chns, int *values, void *keyp, unsigned key_size, unsigned hash, int *value,
                 unsigned capacity) {
...
void map_impl_put(int *busybits, void **keyps, unsigned *k_hashes, int *chns, int *values, void *keyp, unsigned hash, int value, unsigned capacity) {
...
void map_impl_erase(int *busybits, void **keyps, unsigned *k_hashes, int *chns, void *keyp, unsigned key_size, unsigned hash, unsigned capacity,
                    void **keyp_out) {
